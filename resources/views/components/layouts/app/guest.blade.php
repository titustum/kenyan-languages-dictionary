...
<body class="bg-white text-gray-900 dark:bg-gray-900 dark:text-white transition-colors duration-500 overflow-x-hidden">
    ...
    <nav id="mobile-nav"
        class="fixed top-0 left-0 h-full w-80 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 border-r border-gray-200 dark:border-gray-700 z-50 transform slide-in-left transition-transform duration-300 ease-in-out lg:hidden shadow-lg">
        <div class="flex flex-col h-full">
            ...
            <div class="flex-1 px-6 py-8 overflow-y-auto">
                <div class="space-y-6">
                    ...
                    <a href="/languages"
                        class="flex items-center space-x-3 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white transition-colors">
