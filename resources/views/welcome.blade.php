    ...
    <section id="languages"
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative">
            <div class="text-center mb-20">
                ...
                <h2
                    class="text-5xl md:text-6xl py-4 font-bold mb-8 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 dark:from-white dark:via-blue-100 dark:to-emerald-200 bg-clip-text text-transparent">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
                @php
                $enhancedColors = [
                'red' => 'from-red-500 to-red-600 shadow-lg shadow-red-500/30 text-white',
                'yellow' => 'from-yellow-400 to-yellow-500 shadow-lg shadow-yellow-500/30 text-gray-900',
                'green' => 'from-green-500 to-green-600 shadow-lg shadow-green-500/30 text-white',
                'blue' => 'from-blue-500 to-blue-600 shadow-lg shadow-blue-500/30 text-white',
                'indigo' => 'from-indigo-500 to-indigo-600 shadow-lg shadow-indigo-500/30 text-white',
                'purple' => 'from-purple-500 to-purple-600 shadow-lg shadow-purple-500/30 text-white',
                'pink' => 'from-pink-500 to-pink-600 shadow-lg shadow-pink-500/30 text-white',
                'orange' => 'from-orange-500 to-orange-600 shadow-lg shadow-orange-500/30 text-white',
                'teal' => 'from-teal-500 to-teal-600 shadow-lg shadow-teal-500/30 text-white',
                'cyan' => 'from-cyan-500 to-cyan-600 shadow-lg shadow-cyan-500/30 text-white',
                ...
                'gray' => 'from-gray-500 to-gray-600 shadow-lg shadow-gray-500/30 text-white',
                'rose' => 'from-rose-500 to-rose-600 shadow-lg shadow-rose-500/30 text-white',
                'brown' => 'from-yellow-800 to-yellow-900 shadow-lg shadow-yellow-800/30 text-white',
                ];
                @endphp
                ...
                <a href="{{ route('languages.entries', $language) }}"
                    class="group relative bg-gradient-to-br {{ $enhancedColors[$language->color] }} dark:from-gray-700 dark:to-gray-800 rounded-2xl p-6 text-center cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-gray-200 dark:border-white/10 backdrop-blur-sm">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="text-xs opacity-75 flex justify-center items-center space-x-2">
                            <span class="flex items-center text-gray-200 dark:text-gray-400">
                ...
                <a href="/languages"
                    class="group relative bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 dark:from-slate-700 dark:via-slate-600 dark:to-slate-500 rounded-2xl p-6 text-center cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-gray-300 dark:border-white/20 backdrop-blur-sm overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="font-bold text-lg mb-2 text-gray-900 dark:text-white">+{{ $remainingLanguagesCount
                            }}
                            More</div>
                        <div class="text-sm opacity-90 text-gray-600 dark:text-gray-300 mb-3">Discover All Languages
                        </div>
                        <div class="text-xs text-gray-500 dark:text-gray-400">Click to explore →</div>
                    </div>
                </a>
            </div>

            <div class="mt-12 flex flex-wrap justify-center gap-3">
                @foreach (['All Regions','Nyanza Kenya','Western Kenya','Rift Valley Kenya','Central Kenya','Coast
                Region','Northern Kenya','Eastern Kenya'] as $tag)
                <button
                    class="px-4 py-2 bg-white/70 dark:bg-black/10 backdrop-blur-sm border border-gray-300 dark:border-white/20 rounded-full text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-black/20 hover:text-gray-900 dark:hover:text-white transition-all duration-300">
                    {{ $tag }}
                </button>
                @endforeach
            </div>
